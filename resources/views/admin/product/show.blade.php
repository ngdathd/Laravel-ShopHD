                                ...
                                <div class="fixed-table-body">
                                    ...
                                    <table data-toggle="table"
                                        ...
                                        <tr>
                                            ...
                                            <th style="">
                                                <div class="th-inner sortable">Thumbnail</div>
                                                <div class="fht-cell"></div>
                                            </th>
                                            <th style="">
                                            ...
                                            <th style="">
                                                <div class="th-inner sortable">Product</div>
                                                <div class="fht-cell"></div>
                                            </th>
                                            <th style="">
                                                <div class="th-inner sortable">Price</div>
                                                <div class="fht-cell"></div>
                                            </th>
                                            <th style="">
                                        ...
                                        @if(isset($products))
                                            @foreach($products as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{$key + 1}}</td>
                                                    <td>
                                                        <img class="img-responsive menu-thumbnails"
